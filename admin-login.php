...
if (isset($_POST['login'])) {
    if ($_POST['emp_code'] != "" || $_POST['password'] != "") {
        ...
        $sql = "SELECT id,emp_code,name,user_type FROM admin_users WHERE emp_code = '{$emp_code}' AND password = '{$password}'";
...
<div class="login-container">
    <div class="login-area">
        ...
        <form action="<?php $_SERVER['PHP_SELF']; ?>" class="login-form" method="POST">
            <input type="text" name="emp_code" id="emp_code" placeholder="Admin id...">
